...
// Generated
#include "ROS2DiagDiagnosticStatus.generated.h"

USTRUCT(Blueprintable)
struct RCLUE_API FROSDiagDiagnosticStatus
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FROSDiagKeyValue> Values;

	

	FROSDiagDiagnosticStatus()
	{
	...
	void SetFromROS2(const diagnostic_msgs__msg__DiagnosticStatus& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<diagnostic_msgs__msg__KeyValue, FROSDiagKeyValue>(in_ros_data.values.data, Values, in_ros_data.values.size);
	...
	void SetROS2(diagnostic_msgs__msg__DiagnosticStatus& out_ros_data) const
	{
		...
		if (!diagnostic_msgs__msg__KeyValue__Sequence__init(&out_ros_data.values, Values.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.values  "));}
		UROS2Utils::ArrayUEToROSSequence<diagnostic_msgs__msg__KeyValue, FROSDiagKeyValue>(Values, out_ros_data.values.data, Values.Num());
...
UCLASS()
class RCLUE_API UROS2DiagDiagnosticStatusMsg : public UROS2GenericMsg
{
	GENERATED_BODY()
...
public:
	...
	void SetMsg(const FROSDiagDiagnosticStatus& Input);
	
  	UFUNCTION(BlueprintCallable)
	void GetMsg(FROSDiagDiagnosticStatus& Output) const;
	...
	{
		return FROSDiagDiagnosticStatus::OK;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_WARN()
	{
		return FROSDiagDiagnosticStatus::WARN;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_ERROR()
	{
		return FROSDiagDiagnosticStatus::ERROR;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_STALE()
	{
		return FROSDiagDiagnosticStatus::STALE;
	}
