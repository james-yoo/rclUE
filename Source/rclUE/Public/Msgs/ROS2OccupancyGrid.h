...
public:
	...
	void SetROS2(nav_msgs__msg__OccupancyGrid& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__int8__Sequence__init(&out_ros_data.data, Data.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.data  "));}
