...
// Generated
#include "ROS2FieldType.generated.h"

USTRUCT(Blueprintable)
struct RCLUE_API FROSFieldType
{
	GENERATED_BODY()
...
UCLASS()
class RCLUE_API UROS2FieldTypeMsg : public UROS2GenericMsg
{
	GENERATED_BODY()
...
public:
	...
	void SetMsg(const FROSFieldType& Input);
	
  	UFUNCTION(BlueprintCallable)
	void GetMsg(FROSFieldType& Output) const;
	...
	{
		return FROSFieldType::FIELD_TYPE_NOT_SET;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_NESTED_TYPE()
	{
		return FROSFieldType::FIELD_TYPE_NESTED_TYPE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT8()
	{
		return FROSFieldType::FIELD_TYPE_INT8;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT8()
	{
		return FROSFieldType::FIELD_TYPE_UINT8;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT16()
	{
		return FROSFieldType::FIELD_TYPE_INT16;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT16()
	{
		return FROSFieldType::FIELD_TYPE_UINT16;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT32()
	{
		return FROSFieldType::FIELD_TYPE_INT32;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT32()
	{
		return FROSFieldType::FIELD_TYPE_UINT32;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT64()
	{
		return FROSFieldType::FIELD_TYPE_INT64;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT64()
	{
		return FROSFieldType::FIELD_TYPE_UINT64;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FLOAT()
	{
		return FROSFieldType::FIELD_TYPE_FLOAT;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_DOUBLE()
	{
		return FROSFieldType::FIELD_TYPE_DOUBLE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_LONG_DOUBLE()
	{
		return FROSFieldType::FIELD_TYPE_LONG_DOUBLE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_CHAR()
	{
		return FROSFieldType::FIELD_TYPE_CHAR;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WCHAR()
	{
		return FROSFieldType::FIELD_TYPE_WCHAR;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOOLEAN()
	{
		return FROSFieldType::FIELD_TYPE_BOOLEAN;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BYTE()
	{
		return FROSFieldType::FIELD_TYPE_BYTE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_STRING()
	{
		return FROSFieldType::FIELD_TYPE_STRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WSTRING()
	{
		return FROSFieldType::FIELD_TYPE_WSTRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_STRING()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_STRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_WSTRING()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_WSTRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_STRING()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_STRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_WSTRING()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_WSTRING;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_NESTED_TYPE_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_NESTED_TYPE_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT8_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_INT8_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT8_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_UINT8_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT16_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_INT16_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT16_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_UINT16_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT32_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_INT32_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT32_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_UINT32_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT64_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_INT64_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT64_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_UINT64_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FLOAT_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_FLOAT_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_DOUBLE_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_DOUBLE_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_LONG_DOUBLE_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_LONG_DOUBLE_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_CHAR_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_CHAR_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WCHAR_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_WCHAR_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOOLEAN_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_BOOLEAN_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BYTE_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_BYTE_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_STRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_STRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WSTRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_WSTRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_STRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_STRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_WSTRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_WSTRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_STRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_STRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_WSTRING_ARRAY()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_WSTRING_ARRAY;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_NESTED_TYPE_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_NESTED_TYPE_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT8_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT8_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT8_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT8_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT16_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT16_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT16_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT16_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT32_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT32_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT32_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT32_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT64_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT64_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT64_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT64_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FLOAT_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FLOAT_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_DOUBLE_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_DOUBLE_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_LONG_DOUBLE_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_LONG_DOUBLE_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_CHAR_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_CHAR_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WCHAR_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_WCHAR_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOOLEAN_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOOLEAN_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BYTE_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BYTE_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_STRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_STRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WSTRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_WSTRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_STRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_STRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_WSTRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_WSTRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_STRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_STRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_WSTRING_BOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_WSTRING_BOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT8_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT8_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT8_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT8_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT16_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT16_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT16_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT16_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT32_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT32_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT32_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT32_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_INT64_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_INT64_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_UINT64_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_UINT64_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FLOAT_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_DOUBLE_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_DOUBLE_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_LONG_DOUBLE_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_LONG_DOUBLE_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_CHAR_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_CHAR_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WCHAR_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_WCHAR_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOOLEAN_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOOLEAN_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BYTE_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BYTE_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_STRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_STRING_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_WSTRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_WSTRING_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_STRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_STRING_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_FIXED_WSTRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_FIXED_WSTRING_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_STRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_STRING_UNBOUNDED_SEQUENCE;
	}
	UFUNCTION(BlueprintCallable)
	static uint8 CONST_FIELD_TYPE_BOUNDED_WSTRING_UNBOUNDED_SEQUENCE()
	{
		return FROSFieldType::FIELD_TYPE_BOUNDED_WSTRING_UNBOUNDED_SEQUENCE;
	}
