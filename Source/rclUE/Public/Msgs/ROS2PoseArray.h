...
public:
	...
	void SetROS2(geometry_msgs__msg__PoseArray& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__Pose__Sequence__init(&out_ros_data.poses, Poses.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.poses  "));}
