...
public:
	...
	void SetFromROS2(const sensor_msgs__msg__PointCloud& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<geometry_msgs__msg__Point32, FROSPoint32>(in_ros_data.points.data, Points, in_ros_data.points.size);

		UROS2Utils::SequenceROSToUEArray<sensor_msgs__msg__ChannelFloat32, FROSChannelFloat32>(in_ros_data.channels.data, Channels, in_ros_data.channels.size);
	...
	void SetROS2(sensor_msgs__msg__PointCloud& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__Point32__Sequence__init(&out_ros_data.points, Points.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.points  "));}
		...
		if (!sensor_msgs__msg__ChannelFloat32__Sequence__init(&out_ros_data.channels, Channels.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.channels  "));}
		UROS2Utils::ArrayUEToROSSequence<sensor_msgs__msg__ChannelFloat32, FROSChannelFloat32>(Channels, out_ros_data.channels.data, Channels.Num());
