...
public:
	...
	void SetROS2(visualization_msgs__msg__InteractiveMarker& out_ros_data) const
	{
		...
		if (!visualization_msgs__msg__MenuEntry__Sequence__init(&out_ros_data.menu_entries, MenuEntries.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.menu_entries  "));}
		...
		if (!visualization_msgs__msg__InteractiveMarkerControl__Sequence__init(&out_ros_data.controls, Controls.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.controls  "));}
