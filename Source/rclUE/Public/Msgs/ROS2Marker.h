...
public:
	...
	static constexpr int ARROW_STRIP = 12;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FROSStdColorRGBA> Colors;
	...
	void SetFromROS2(const visualization_msgs__msg__Marker& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<std_msgs__msg__ColorRGBA, FROSStdColorRGBA>(in_ros_data.colors.data, Colors, in_ros_data.colors.size);
		...
		UROS2Utils::SequenceROSToUEArray<visualization_msgs__msg__UVCoordinate, FROSUVCoordinate>(in_ros_data.uv_coordinates.data, UvCoordinates, in_ros_data.uv_coordinates.size);
	...
	void SetROS2(visualization_msgs__msg__Marker& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__Point__Sequence__init(&out_ros_data.points, Points.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.points  "));}
		...
		if (!std_msgs__msg__ColorRGBA__Sequence__init(&out_ros_data.colors, Colors.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.colors  "));}
		UROS2Utils::ArrayUEToROSSequence<std_msgs__msg__ColorRGBA, FROSStdColorRGBA>(Colors, out_ros_data.colors.data, Colors.Num());
		...
		if (!visualization_msgs__msg__UVCoordinate__Sequence__init(&out_ros_data.uv_coordinates, UvCoordinates.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.uv_coordinates  "));}
		UROS2Utils::ArrayUEToROSSequence<visualization_msgs__msg__UVCoordinate, FROSUVCoordinate>(UvCoordinates, out_ros_data.uv_coordinates.data, UvCoordinates.Num());
...
public:
	...
	UFUNCTION(BlueprintCallable)
	static int CONST_ARROW_STRIP()
	{
		return FROSMarker::ARROW_STRIP;
	}
	UFUNCTION(BlueprintCallable)
