...
public:
	...
	void SetROS2(sensor_msgs__msg__JointState& out_ros_data) const
	{
		...
		if (!rosidl_runtime_c__float64__Sequence__init(&out_ros_data.effort, Effort.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.effort  "));}
