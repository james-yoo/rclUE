...
public:
	...
	void SetFromROS2(const trajectory_msgs__msg__JointTrajectory& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<trajectory_msgs__msg__JointTrajectoryPoint, FROSJointTrajPoint>(in_ros_data.points.data, Points, in_ros_data.points.size);
	...
	void SetROS2(trajectory_msgs__msg__JointTrajectory& out_ros_data) const
	{
		...
		if (!trajectory_msgs__msg__JointTrajectoryPoint__Sequence__init(&out_ros_data.points, Points.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.points  "));}
		UROS2Utils::ArrayUEToROSSequence<trajectory_msgs__msg__JointTrajectoryPoint, FROSJointTrajPoint>(Points, out_ros_data.points.data, Points.Num());
