...
public:
	...
	void SetFromROS2(const sensor_msgs__msg__MultiDOFJointState& in_ros_data)
	{
		...
		UROS2Utils::SequenceROSToUEArray<geometry_msgs__msg__Twist, FROSTwist>(in_ros_data.twist.data, Twist, in_ros_data.twist.size);

		UROS2Utils::SequenceROSToUEArray<geometry_msgs__msg__Wrench, FROSWrench>(in_ros_data.wrench.data, Wrench, in_ros_data.wrench.size);
	...
	void SetROS2(sensor_msgs__msg__MultiDOFJointState& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__Twist__Sequence__init(&out_ros_data.twist, Twist.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.twist  "));}
		...
		if (!geometry_msgs__msg__Wrench__Sequence__init(&out_ros_data.wrench, Wrench.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.wrench  "));}
