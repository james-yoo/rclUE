...
// Generated
#include "ROS2DiagKeyValue.generated.h"

USTRUCT(Blueprintable)
struct RCLUE_API FROSDiagKeyValue
{
	GENERATED_BODY()
...
UCLASS()
class RCLUE_API UROS2DiagKeyValueMsg : public UROS2GenericMsg
{
	GENERATED_BODY()
...
public:
	...
	void SetMsg(const FROSDiagKeyValue& Input);
	
  	UFUNCTION(BlueprintCallable)
	void GetMsg(FROSDiagKeyValue& Output) const;
