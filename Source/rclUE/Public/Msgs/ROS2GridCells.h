...
public:
	...
	void SetROS2(nav_msgs__msg__GridCells& out_ros_data) const
	{
		...
		if (!geometry_msgs__msg__Point__Sequence__init(&out_ros_data.cells, Cells.Num())) {UE_LOG_WITH_INFO(LogTemp, Error, TEXT("failed to create array for field out_ros_data.cells  "));}
