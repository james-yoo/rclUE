...
static char tf2_msgs__msg__TFMessage__FIELD_NAME__transforms[] = "transforms";

static rosidl_runtime_c__type_description__Field tf2_msgs__msg__TFMessage__FIELDS[] = {
  {
    {tf2_msgs__msg__TFMessage__FIELD_NAME__transforms, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription tf2_msgs__msg__TFMessage__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {tf2_msgs__msg__TFMessage__FIELDS, 1, 1},
    },
    {tf2_msgs__msg__TFMessage__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
tf2_msgs__msg__TFMessage__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *tf2_msgs__msg__TFMessage__get_individual_type_description_source(NULL),
