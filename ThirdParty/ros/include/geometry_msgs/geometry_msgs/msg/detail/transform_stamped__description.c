...
geometry_msgs__msg__TransformStamped__get_type_hash(
...
static char geometry_msgs__msg__TransformStamped__FIELD_NAME__header[] = "header";
static char geometry_msgs__msg__TransformStamped__FIELD_NAME__child_frame_id[] = "child_frame_id";
static char geometry_msgs__msg__TransformStamped__FIELD_NAME__transform[] = "transform";

static rosidl_runtime_c__type_description__Field geometry_msgs__msg__TransformStamped__FIELDS[] = {
  {
    {geometry_msgs__msg__TransformStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geometry_msgs__msg__TransformStamped__FIELD_NAME__child_frame_id, 14, 14},
    {
  ...
  {
    {geometry_msgs__msg__TransformStamped__FIELD_NAME__transform, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geometry_msgs__msg__TransformStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
geometry_msgs__msg__TransformStamped__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {geometry_msgs__msg__TransformStamped__FIELDS, 3, 3},
    },
    {geometry_msgs__msg__TransformStamped__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
geometry_msgs__msg__TransformStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {geometry_msgs__msg__TransformStamped__TYPE_NAME, 34, 34},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 748, 748},
  };
  return &source;
}

const rosidl_runtime_c__type_description__TypeSource__Sequence *
geometry_msgs__msg__TransformStamped__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geometry_msgs__msg__TransformStamped__get_individual_type_description_source(NULL),
