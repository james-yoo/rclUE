...
static const rosidl_type_hash_t geometry_msgs__msg__AccelWithCovariance__EXPECTED_HASH = {1, {
...
static char geometry_msgs__msg__AccelWithCovarianceStamped__TYPE_NAME[] = "geometry_msgs/msg/AccelWithCovarianceStamped";
...
static char geometry_msgs__msg__AccelWithCovarianceStamped__FIELD_NAME__header[] = "header";
static char geometry_msgs__msg__AccelWithCovarianceStamped__FIELD_NAME__accel[] = "accel";

static rosidl_runtime_c__type_description__Field geometry_msgs__msg__AccelWithCovarianceStamped__FIELDS[] = {
  {
    {geometry_msgs__msg__AccelWithCovarianceStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geometry_msgs__msg__AccelWithCovarianceStamped__FIELD_NAME__accel, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geometry_msgs__msg__AccelWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {geometry_msgs__msg__AccelWithCovarianceStamped__TYPE_NAME, 44, 44},
      {geometry_msgs__msg__AccelWithCovarianceStamped__FIELDS, 2, 2},
    },
    {geometry_msgs__msg__AccelWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&geometry_msgs__msg__AccelWithCovariance__EXPECTED_HASH, geometry_msgs__msg__AccelWithCovariance__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[2].fields = geometry_msgs__msg__AccelWithCovariance__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geometry_msgs__msg__AccelWithCovarianceStamped__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Accel__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__AccelWithCovariance__get_individual_type_description_source(NULL);
