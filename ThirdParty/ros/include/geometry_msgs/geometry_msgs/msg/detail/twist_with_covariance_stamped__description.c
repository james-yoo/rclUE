...
static char geometry_msgs__msg__TwistWithCovarianceStamped__TYPE_NAME[] = "geometry_msgs/msg/TwistWithCovarianceStamped";
...
static char geometry_msgs__msg__TwistWithCovarianceStamped__FIELD_NAME__header[] = "header";
static char geometry_msgs__msg__TwistWithCovarianceStamped__FIELD_NAME__twist[] = "twist";

static rosidl_runtime_c__type_description__Field geometry_msgs__msg__TwistWithCovarianceStamped__FIELDS[] = {
  {
    {geometry_msgs__msg__TwistWithCovarianceStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {geometry_msgs__msg__TwistWithCovarianceStamped__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription geometry_msgs__msg__TwistWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {geometry_msgs__msg__TwistWithCovarianceStamped__TYPE_NAME, 44, 44},
      {geometry_msgs__msg__TwistWithCovarianceStamped__FIELDS, 2, 2},
    },
    {geometry_msgs__msg__TwistWithCovarianceStamped__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = geometry_msgs__msg__TwistWithCovariance__get_type_description(NULL)->type_description.fields;
...
geometry_msgs__msg__TwistWithCovarianceStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *geometry_msgs__msg__TwistWithCovarianceStamped__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *geometry_msgs__msg__Twist__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__TwistWithCovariance__get_individual_type_description_source(NULL);
