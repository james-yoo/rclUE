...
static char nav_msgs__msg__OccupancyGrid__FIELD_NAME__header[] = "header";
static char nav_msgs__msg__OccupancyGrid__FIELD_NAME__info[] = "info";
static char nav_msgs__msg__OccupancyGrid__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field nav_msgs__msg__OccupancyGrid__FIELDS[] = {
  {
    {nav_msgs__msg__OccupancyGrid__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {nav_msgs__msg__OccupancyGrid__FIELD_NAME__info, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav_msgs__msg__OccupancyGrid__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav_msgs__msg__OccupancyGrid__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav_msgs__msg__OccupancyGrid__FIELDS, 3, 3},
    },
    {nav_msgs__msg__OccupancyGrid__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
nav_msgs__msg__OccupancyGrid__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav_msgs__msg__OccupancyGrid__get_individual_type_description_source(NULL),
