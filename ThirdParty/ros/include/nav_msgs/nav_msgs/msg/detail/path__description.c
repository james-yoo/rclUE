...
static char nav_msgs__msg__Path__FIELD_NAME__header[] = "header";
static char nav_msgs__msg__Path__FIELD_NAME__poses[] = "poses";

static rosidl_runtime_c__type_description__Field nav_msgs__msg__Path__FIELDS[] = {
  {
    {nav_msgs__msg__Path__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {nav_msgs__msg__Path__FIELD_NAME__poses, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav_msgs__msg__Path__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav_msgs__msg__Path__FIELDS, 2, 2},
    },
    {nav_msgs__msg__Path__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
nav_msgs__msg__Path__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav_msgs__msg__Path__get_individual_type_description_source(NULL),
