...
static const rosidl_type_hash_t visualization_msgs__msg__InteractiveMarkerPose__EXPECTED_HASH = {1, {
...
static char visualization_msgs__msg__InteractiveMarkerUpdate__TYPE_NAME[] = "visualization_msgs/msg/InteractiveMarkerUpdate";
...
static char visualization_msgs__msg__InteractiveMarkerPose__TYPE_NAME[] = "visualization_msgs/msg/InteractiveMarkerPose";
...
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__server_id[] = "server_id";
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__seq_num[] = "seq_num";
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__type[] = "type";
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__markers[] = "markers";
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__poses[] = "poses";
static char visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__erases[] = "erases";

static rosidl_runtime_c__type_description__Field visualization_msgs__msg__InteractiveMarkerUpdate__FIELDS[] = {
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__server_id, 9, 9},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__seq_num, 7, 7},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__type, 4, 4},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__markers, 7, 7},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__poses, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {visualization_msgs__msg__InteractiveMarkerPose__TYPE_NAME, 44, 44},
    },
    {NULL, 0, 0},
  },
  {
    {visualization_msgs__msg__InteractiveMarkerUpdate__FIELD_NAME__erases, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription visualization_msgs__msg__InteractiveMarkerUpdate__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {visualization_msgs__msg__InteractiveMarkerUpdate__TYPE_NAME, 46, 46},
      {visualization_msgs__msg__InteractiveMarkerUpdate__FIELDS, 6, 6},
    },
    {visualization_msgs__msg__InteractiveMarkerUpdate__REFERENCED_TYPE_DESCRIPTIONS, 16, 16},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&visualization_msgs__msg__InteractiveMarkerPose__EXPECTED_HASH, visualization_msgs__msg__InteractiveMarkerPose__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[11].fields = visualization_msgs__msg__InteractiveMarkerPose__get_type_description(NULL)->type_description.fields;
...
visualization_msgs__msg__InteractiveMarkerUpdate__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *visualization_msgs__msg__InteractiveMarkerUpdate__get_individual_type_description_source(NULL),
    ...
    sources[12] = *visualization_msgs__msg__InteractiveMarkerPose__get_individual_type_description_source(NULL);
