...
static char visualization_msgs__msg__InteractiveMarkerInit__TYPE_NAME[] = "visualization_msgs/msg/InteractiveMarkerInit";
...
static char visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__server_id[] = "server_id";
static char visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__seq_num[] = "seq_num";
static char visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__markers[] = "markers";

static rosidl_runtime_c__type_description__Field visualization_msgs__msg__InteractiveMarkerInit__FIELDS[] = {
  {
    {visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__server_id, 9, 9},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__seq_num, 7, 7},
    {
  ...
  {
    {visualization_msgs__msg__InteractiveMarkerInit__FIELD_NAME__markers, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription visualization_msgs__msg__InteractiveMarkerInit__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {visualization_msgs__msg__InteractiveMarkerInit__TYPE_NAME, 44, 44},
      {visualization_msgs__msg__InteractiveMarkerInit__FIELDS, 3, 3},
    },
    {visualization_msgs__msg__InteractiveMarkerInit__REFERENCED_TYPE_DESCRIPTIONS, 15, 15},
  };
  if (!constructed) {
...
visualization_msgs__msg__InteractiveMarkerInit__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {visualization_msgs__msg__InteractiveMarkerInit__TYPE_NAME, 44, 44},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 475, 475},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *visualization_msgs__msg__InteractiveMarkerInit__get_individual_type_description_source(NULL),
