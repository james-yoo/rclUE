...
static char visualization_msgs__msg__MarkerArray__TYPE_NAME[] = "visualization_msgs/msg/MarkerArray";
...
static char visualization_msgs__msg__MarkerArray__FIELD_NAME__markers[] = "markers";

static rosidl_runtime_c__type_description__Field visualization_msgs__msg__MarkerArray__FIELDS[] = {
  {
    {visualization_msgs__msg__MarkerArray__FIELD_NAME__markers, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription visualization_msgs__msg__MarkerArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {visualization_msgs__msg__MarkerArray__TYPE_NAME, 34, 34},
      {visualization_msgs__msg__MarkerArray__FIELDS, 1, 1},
    },
    {visualization_msgs__msg__MarkerArray__REFERENCED_TYPE_DESCRIPTIONS, 12, 12},
  };
  if (!constructed) {
...
visualization_msgs__msg__MarkerArray__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *visualization_msgs__msg__MarkerArray__get_individual_type_description_source(NULL),
