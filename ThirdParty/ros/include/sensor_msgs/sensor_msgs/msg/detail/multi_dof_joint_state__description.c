...
static char sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__header[] = "header";
static char sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__joint_names[] = "joint_names";
static char sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__transforms[] = "transforms";
static char sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__twist[] = "twist";
static char sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__wrench[] = "wrench";

static rosidl_runtime_c__type_description__Field sensor_msgs__msg__MultiDOFJointState__FIELDS[] = {
  {
    {sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__joint_names, 11, 11},
    {
  ...
  {
    {sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__transforms, 10, 10},
    {
  ...
  {
    {sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
  ...
  {
    {sensor_msgs__msg__MultiDOFJointState__FIELD_NAME__wrench, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription sensor_msgs__msg__MultiDOFJointState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {sensor_msgs__msg__MultiDOFJointState__FIELDS, 5, 5},
    },
    {sensor_msgs__msg__MultiDOFJointState__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
sensor_msgs__msg__MultiDOFJointState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {sensor_msgs__msg__MultiDOFJointState__TYPE_NAME, 34, 34},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 1208, 1208},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *sensor_msgs__msg__MultiDOFJointState__get_individual_type_description_source(NULL),
