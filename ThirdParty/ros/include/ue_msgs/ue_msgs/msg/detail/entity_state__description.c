...
static char ue_msgs__msg__EntityState__FIELD_NAME__name[] = "name";
static char ue_msgs__msg__EntityState__FIELD_NAME__pose[] = "pose";
static char ue_msgs__msg__EntityState__FIELD_NAME__twist[] = "twist";
static char ue_msgs__msg__EntityState__FIELD_NAME__reference_frame[] = "reference_frame";

static rosidl_runtime_c__type_description__Field ue_msgs__msg__EntityState__FIELDS[] = {
  {
    {ue_msgs__msg__EntityState__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {ue_msgs__msg__EntityState__FIELD_NAME__pose, 4, 4},
    {
  ...
  {
    {ue_msgs__msg__EntityState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ue_msgs__msg__EntityState__FIELD_NAME__reference_frame, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ue_msgs__msg__EntityState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ue_msgs__msg__EntityState__FIELDS, 4, 4},
    },
    {ue_msgs__msg__EntityState__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
ue_msgs__msg__EntityState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ue_msgs__msg__EntityState__get_individual_type_description_source(NULL),
